...
export const VOLUME_TIERS = [
  { quantity: 50, unitPrice: 180, label: '50 Cartes PVC (Lot Démarrage)', total: 9000 },
  { quantity: 100, unitPrice: 150, label: '100 Cartes PVC (Standard Atelier)', total: 15000, popular: true },
  { quantity: 250, unitPrice: 120, label: '250 Cartes PVC (Recommandé)', total: 30000 },
  { quantity: 500, unitPrice: 95, label: '500 Cartes PVC (Grand Débit)', total: 47500 },
  { quantity: 1000, unitPrice: 80, label: '1,000 Cartes PVC (Volume Concession)', total: 80000 },
];
